...
public class Deck {
    ...
    public String drawCard() {
        // Should be calling this.getLength() vs this.cards.getLength(). The getLength() method is already using this.cards.
        int j = (int) (Math.random() * this.getLength());
        Card draw = this.getCard(j);
